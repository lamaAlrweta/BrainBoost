...
const I18n = (() => {
  ...
  const translations = {
    ...
    ar: {
      ...
      hero_desc: 'حوِّل أسئلة الواجب إلى تحديات ممتعة. خض 3 جولات سريعة صُمِّمت لتبسِّط لك المفاهيم، وبمجرد حلها ستحصل على الإجابة النموذجية. اجمع النقاط، وارفع مستواك بجهدك!',
